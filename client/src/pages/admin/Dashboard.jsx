...
import { BarChart, Bar, XAxis, YAxis, Tooltip, ResponsiveContainer, Legend, CartesianGrid, LineChart, Line, Area } from 'recharts';
...
const AdminDashboard = () => {
  ...
  const profData = [
    ...
    { name: 'Tamba Tonguino', semaine: 3, mois: 12 },
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      >
        ...
        <p className="mt-2 text-gray-600">Bienvenue dans votre espace de gestion</p>
      </motion.div>
        ...
        >
          ...
          <div className="space-y-4">
            <div className="flex items-center">
              ...
              <p className="text-gray-600">Mise à jour de l'emploi du temps - L1 Info</p>
            </div>
            <div className="flex items-center">
              <div className="w-2 h-2 bg-blue-500 rounded-full mr-3"></div>
              <p className="text-gray-600">Nouveau feedback reçu - Mathématiques</p>
            </div>
            <div className="flex items-center">
        ...
        >
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <p className="text-gray-600">Vérifier les présences de la semaine</p>
      ...
      <div className="mt-12">
        <h2 className="text-2xl font-bold mb-4">Statistiques de présence des professeurs</h2>
        <div className="bg-white rounded-xl shadow p-6 mb-8">
          <ResponsiveContainer width="100%" height={350}>
            <BarChart data={profData} margin={{ top: 20, right: 30, left: 0, bottom: 5 }}>
              <CartesianGrid strokeDasharray="3 3" />
              <XAxis dataKey="name" />
              <YAxis />
              <Tooltip />
              <Legend />
              <Bar dataKey="semaine" fill="#3b82f6" name="Présences cette semaine" />
        ...
        <div className="bg-white rounded-xl shadow p-6">
          <h3 className="text-xl font-semibold mb-4">Évolution du taux de présence des professeurs (ce mois)</h3>
