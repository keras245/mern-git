...
const ChefModal = ({ chef, onClose, onSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!chef || (chef && formData.mot_de_passe)) {
    ...
    >
      <div className="bg-white rounded-lg w-full max-w-md p-6">
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label className="text-sm font-bold text-gray-800 mb-2 block">Matricule</label>
            <input
              type="text"
          ...
          <div className="md:col-span-2">
            <label className="text-sm font-bold text-gray-800 mb-2 block">Classe</label>
            <input
              type="text"
          ...
          <div className="md:col-span-2">
            <label className="text-sm font-bold text-gray-800 mb-2 block">
              Mot de passe {chef && '(requis pour modification)'}
            </label>
